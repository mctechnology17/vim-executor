...
command! -nargs=0 ExecutorToggleResizeWindows   call executor#ToggleResizeWindows()
command! -nargs=0 ExecutorDebugger              call executor#Debugger()
command! -nargs=0 ExecutorToggleDebuggerDefine  call executor#ToggleDebuggerDefine()
